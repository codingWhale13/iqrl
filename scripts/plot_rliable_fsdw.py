...
RLIABLE_REPS = 50000
MAX_RETURN = 1000
XLABEL_Y_COORD_MEAN = -0.3
XLABEL_Y_COORD_PER_TASK = -0.25
...
mt_run_ids = {
    ...
    mt_algos[1]: ["5p4x99jf", "801p4xqw", "9rluaag8", "pbfo0g6u", "g2uxolh1"],
    mt_algos[2]: ["9ds0gqlf", "jc6qx720", "lony30ju", "5dtg5clo", "7r0ai7p0"],
    mt_algos[3]: ["ye2ldolb", "g2zxgbgy", "ud6uothg", "a0jn1j7q", "d2iaolgf"],
}
