...
mt_metric = (
    ...
    f"Normalized Mean Return Across {BENCHMARK} Environments",
)
st_metrics = [
...
fig, axes = plot_utils.plot_interval_estimates(
    ...
    xlabel="Normalized Return per Walker-All Environment",
    colors=colors,
)
...
for i, ax in enumerate(axes):
    ...
    # Avoid overlap of plots (a bit hacky in this one...)
    if i in [0, 2]:
