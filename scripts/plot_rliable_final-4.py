...
st_run_ids = {
    st_algos[0]: {
        st_metrics[0][1]: ["6vulo89q", "my4zf30e", "0pmnvezl", "27pgwdde", "fxjknclp"],
        st_metrics[1][1]: ["2rsz5dbs", "6ofo8jn3", "f7am5zzr", "j6r55wdp", "v7wsizsz"],
        st_metrics[2][1]: ["1mjfvf08", "hzct25nc", "nh7kl3zn", "pkhw7xx5", "rqj76w8y"],
        st_metrics[3][1]: ["a9x80j30", "uk1e5id0", "70obpjwj", "tctljema", "x2eunga6"],
    }
}
# Re-order for non-overlapping values in x-axis
# (Also works nicely because scores increase from left to right across tasks)
st_metrics = [
    (("eval/", "pendulum-swingup", "episodic_return"), "pendulum-swingup"),
    (("eval/", "finger-spin", "episodic_return"), "finger-spin"),
    (("eval/", "cup-catch", "episodic_return"), "cup-catch"),
